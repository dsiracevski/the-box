...
@section('content')
    ...
    <div class="h-screen bg-gradient-to-br from-gray-50 to-gray-500-600 flex justify-center items-center w-full">
        ...
        <form action="{{route('store-sentence')}}" method="POST">
            @csrf

            <div class="bg-white px-10 py-8 rounded-xl w-max shadow-md max-w-sm">
                <div class="space-y-4">
                    <h1 class="text-center text-2xl font-semibold text-gray-600">Нова Реченица</h1>
                    <div class="flex flex-row">
                        <label for="body" class="mb-1 text-gray-600 font-semibold flex-auto">Име
